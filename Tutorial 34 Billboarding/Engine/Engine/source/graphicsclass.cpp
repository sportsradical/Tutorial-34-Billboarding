...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_FloorModel->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/floor.txt", "../Engine/data/grid01.tga");
	if(!result)
	{
	...
	result = m_BillboardModel->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/square.txt", "../Engine/data/seafloor.tga");
	if(!result)
	{
